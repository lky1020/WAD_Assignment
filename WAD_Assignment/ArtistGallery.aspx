                ...
                <ItemTemplate>
                    <table class="padding-b15" id="artwork-table">
                        ...
                        <tr class="text-a1 padding-b15">
                            <td>
                                <asp:Label ID="ArtNameLabel" runat="server" Text='<%# Eval("ArtName") %>' /></td>
                        </tr>
                        <tr class="text-a2">
                            <td>
                                <asp:Label ID="ArtDescriptionLabel" runat="server" Text='<%# Eval("ArtDescription") %>' /></td>
                        </tr>
                        <tr class="text-a3">
                            <td>RM
                                <asp:Label ID="PriceLabel" runat="server" Text='<%# String.Format("{0:0.00}", Eval("Price"))  %>' /></td>
                        </tr>
                    </table>
                </ItemTemplate>
            </asp:DataList>
